...
def question_specs(state: dict[str, Any]) -> dict[str, Any]:
    ...
    if style == "fifty":
        ...
        target_instructions = (
            ...
            "external context. Decide for yourself which information is useful, irrelevant, "
            "noisy, or conflicting; no technical indicator or past result is a mandatory "
            "rule. The UP/DOWN Choice probabilities are relative choice preferences and "
