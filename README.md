...
- **デイトレ**: `trader_context_v1` を利用、標準15分ごとに10分先を再評価
- **スキャルピング**: `trader_context_v1` を利用、標準60秒ごとに30秒先を再評価。短くするほどtoken消費が増える
